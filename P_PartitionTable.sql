...
BEGIN
	...
	-- Creates a partition function called myRangePF1 that will partition a table into 3 partitions
	EXECUTE ('CREATE PARTITION FUNCTION ' + @FunctionName + '(INT) AS RANGE LEFT FOR VALUES (100, 1000);')

	-- Creates a partition scheme called myRangePS1 that applies myRangePF1 to the 3 filegroups created above  
